...
<div class="container-hero">
      <div class="container">
        <div class="hero">
          <div class="row">
            <div class="col-md-6 col-12">
              <div class="heroteks text-md-start text-center">
                ...
                <div class="row text-start">
                  <div
                    class="col-6 col-md-5 col-lg-4 col-xl-3 text-md-start text-end"
                  >
                    <button type="button" class="btn">Daftar</button>
                  </div>
                  <div class="col-6">
                    <button type="button" class="btn ms-4">Masuk</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-12">
              <div
                class="heromodels d-flex justify-content-center"
                data-aos="fade-up"
                data-aos-anchor-placement="top-bottom"
                data-aos-duration="2000"
              >
                <img class="models" src="/assets/img/Iconmodels.png" alt="Models3D" />
                <img
                  class="checkcross"
                  src="/assets/img/checkCross.png"
                  alt="Models3D"
                />
                <img class="ui" src="/assets/img/UI.png" alt="Models3D" />
                <img class="help" src="/assets/img/Help.png" alt="Models3D" />
              </div>
            </div>
          </div>
        </div>
    ...
    <!-- End of Report -->
     ...
     <!-- start of Footer -->
     <div
        class="footer bg-light d-flex justify-content-center align-items-center p-5"
      >
