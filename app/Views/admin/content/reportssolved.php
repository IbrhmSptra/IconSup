...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Reports Solved</h1>
    </div>

    <!-- Search -->
    <div class="row">
        <div class="col-4">
            <form action="/reportssolved" method="post">
        ...
        <tbody class="table-group-divider">
            ...
            <?php foreach ($reports as $row) : ?>
                <tr class="text-center">
                    ...
                    <td><?php
                        if ($row->solved_on == NULL) {
                            echo "Dummy";
                        } else {
                            echo date("d-m-Y H:i:s", strtotime($row->solved_on));
                        }
                        ?>
                    </td>
                </tr>
